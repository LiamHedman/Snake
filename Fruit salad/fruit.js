...
window.onload = function () {
    ...
    _e = spawnFood(player), green_foodX = _e[0], green_foodY = _e[1];
    _f = spawnFood(player), purple_foodX = _f[0], purple_foodY = _f[1];
...
function print_pause(document, interval) {
